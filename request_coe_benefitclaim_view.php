   ...
   <div class="container-fluid mb-2">
       <div class="card shadow rounded-4">
           <div class="card-body p-4">
               <h5 class="card-title mb-4 text-muted">COE Requisition Form for Benefit Claim:
                   <td>
                       <?php
               ...
               <div class="col-12 col-md-3 mb-4">
                   ...
                   <select class="form-select rounded-4" id="Claim_Type" name="Claim_Type" required disabled>
                       <option value="" disabled <?php echo empty($claim_type) ? 'selected' : ''; ?>>Select an option</option>
                       <option value="SSS" <?php echo empty($claim_type) ? 'selected' : ''; ?>>SSS</option>
                       <option value="PAG-IBIG" <?php echo empty($claim_type) ? 'selected' : ''; ?>>PAG-IBIG</option>
                       <option value="PHILHEALTH" <?php echo empty($claim_type) ? 'selected' : ''; ?>>PHILHEALTH</option>
                   </select>
               </div>

               <div class="col-12 col-md-3 mb-4">
                   <input class="form-check-input me-2" type="checkbox" value="" id="ck_compensation" <?php if ($compensation == 1) echo 'checked'; ?> disabled>
               ...
               <div class="d-flex align-items-center my-4">
                   <hr class="flex-grow-1">
                   <h5 class="mx-3 mb-0 text-muted small">Compensation Information</h5>
                   <hr class="flex-grow-1">
               </div>

               <?php if ($coe_type === 'BENEFIT CLAIM WITH COMPENSATION'): ?>

                   <div id="div_hide_compensation" class="mt-4 mb-2 d-none">

                       <div class="d-flex align-items-center justify-content-between bg-light border rounded-4 shadow-sm p-3" style="max-width: 600px;">
                           <div class="d-flex align-items-center gap-2">
                               <i class="bi bi-eye-fill text-success fs-5"></i>
                               <div class="small text-muted">
                                   <strong>Compensation details</strong> are now visible.
                               </div>
                           </div>

                           <button type="button"
                               id="hideBtn"
                               class="btn btn-outline-secondary rounded-4 px-3 py-1 d-flex align-items-center gap-2"
                               onclick="Hide_Compensation()">
                   ...
                   <div id="div_view_compensation" class="mt-4 mb-2">

                       <div class="d-flex align-items-center justify-content-between bg-light border rounded-4 shadow-sm p-3" style="max-width: 600px;">
                           <div class="d-flex align-items-center gap-2">
                               <i class="bi bi-shield-lock-fill text-warning fs-5"></i>
                               <div class="small text-muted">
                                   <strong>Compensation details</strong> are hidden for security purposes.
                               </div>
                           </div>

                           <button type="button"
                               id="unlockBtn"
                               class="btn btn-dark rounded-4 px-3 py-1 d-flex align-items-center gap-2"
                               onclick="Benefit_Vault_Password('unlockBtn', '<?= $employee_id ?>', '<?= $request_id ?>')">
               ...
               <div id="compensation_wrapper" class="mt-4 mb-2 d-none"></div>

               <div class="col-md-12 ms-auto mt-4" id="attachment-section">
   ...
   <div class="modal fade" id="vaultModal" tabindex="-1" aria-hidden="true">
       <div class="modal-dialog modal-dialog-centered">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <input type="password" class="form-control rounded-4" id="vaultPassword" placeholder="Enter vault password">
                   <div id="vault_error" class="text-danger small mt-2 d-none text-center">Incorrect password.</div>
               </div>
               <div class="modal-footer">
                   <button type="button" class="btn btn-outline-secondary rounded-4" data-bs-dismiss="modal">Cancel</button>
                   <button type="button" id="vault_unlock_btn" class="btn btn-dark rounded-4">
