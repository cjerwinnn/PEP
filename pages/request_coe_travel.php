...
$date_needed = isset($_POST['date_needed']) ? $_POST['date_needed'] : '';
...
<div class="container-fluid mb-2">
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            <h5 class="card-title mb-4 text-muted">COE Requisition Form for <span class="text-primary">Travel</span></h5>

            <div class="row mb-2">
                <div class="col-md-4 mb-4">
                    <label class="form-label small">Request ID</label>
                    <input type="text" class="form-control rounded-4 text-danger" id="req_id" value="<?php echo htmlspecialchars($req_id); ?>" disabled>
                </div>

                <div class="col-md-8 mb-4">
                    <label class="form-label small">COE Type</label>
                    <input type="text" class="form-control rounded-4 text-danger" id="req_coe_type" value="TRAVEL" disabled>
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <textarea class="form-control rounded-4" id="req_reason" rows="2" placeholder="Describe the reason..." oninput="adjustTextareaHeight(this)"></textarea>
            </div>
            ...
            <div class="col-12 col-md-3 mb-2">
                ...
                <div class="position-relative">
                    <input type="date" class="form-control rounded-4 pe-5" id="date_needed" min="<?php echo htmlspecialchars($date_needed); ?>" value="<?php echo htmlspecialchars($date_needed); ?>">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-2">
                    ...
                    <input type="date" class="form-control rounded-4" id="dateFrom" name="dateFrom">
                </div>

                <div class="col-12 col-md-4 mb-2">
                    <label for="dateTo" class="form-label small">Date To <span class="text-danger">*</span></label>
                    <input type="date" class="form-control rounded-4" id="dateTo" name="dateTo">
                </div>
            </div>

            <div class="col-12 col-md-3 mb-2">
                <label for="date_return" class="form-label small">Date Return to Work<span class="text-danger"> *</span></label>
                <input type="date" class="form-control rounded-4" id="date_return">
            </div>

            <div class="col-12 col-md-3 mb-2">
                <label for="receiving_Format" class="form-label small">Travel Type<span class="text-danger"> *</span></label>
                <select class="form-select rounded-4" id="receiving_Format" name="receiving_Format" required>
                    <option value="" disabled selected>Select an option</option>
