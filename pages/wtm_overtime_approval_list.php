    ...
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <h5 class="mb-0 ms-3 text-muted text-center">Overtime Approval</h5>
            </div>
                ...
                <table class="table table-bordered table-hover table-sm small"
                    ...
                    <thead class="thead-light mb-4">
                        <tr class="bg-dark text-white text-center rounded-4">
                            <th class="bg-primary text-white" style="width: 5%;">Image</th>
                            <th class="bg-primary text-white" style="width: 10%;">Employee ID</th>
                            <th class="bg-primary text-white" style="width: 25%;">Employee Name</th>
...
<script src="../assets/js/wtm/wtm_overtime_approval_list.js"></script>
<script>
