...
<div class="container-fluid mb-2">
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            <h5 class="card-title mb-4 text-muted">COE Requisition Form for Training/Educational</span></h5>
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <input type="text" class="form-control rounded-4 text-danger" id="req_coe_type" value="TRAINING/EDUCATIONAL" disabled>
                </div>
            </div>
            ...
            <div class="mb-2">
                ...
                <textarea class="form-control rounded-4" id="req_reason" rows="2" oninput="adjustTextareaHeight(this)" placeholder="Describe the reason..."></textarea>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header">
                <h5 class="modal-title" id="SubmitModalLabel">COE Request for Financial</h5>
