        ...
        <div class="card-body p-4">
            ...
            <div class="cardBox position-relative">
                <div class="d-flex gap-3 flex-wrap">
                    <a href="maintenance_coe_checklist.php" class="btn btn-light shadow rounded-4 px-4 py-3 text-start" style="width: 180px; height: 120px;">
            ...
            <div class="cardBox position-relative">
                <div class="d-flex gap-3 flex-wrap">
                    <a href="maintenance_coe_approval.php" class="btn btn-light shadow rounded-4 px-4 py-3 text-start" style="width: 180px; height: 120px;">
                        <i class="bi bi-journal-text fs-2 text-primary"></i><br>
