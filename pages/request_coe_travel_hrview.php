       ...
       <div class="card shadow rounded-4">
           <div class="card-body p-4">
               ...
               <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-2">
                   <!-- Left side -->
                   <div>
                       <button type="button" id="btn_view_leave" class="btn btn-outline-dark rounded-4 px-5">
                           VIEW LEAVE
                       </button>
                   </div>
       ...
       <div class="modal-dialog modal-dialog-centered modal-md">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   ...
                   <!-- Remarks Textarea -->
                   <div class="mb-3">
                       <textarea class="form-control rounded-4" id="onprocess_remarks" rows="3" oninput="adjustTextareaHeight(this)" placeholder="Remarks..."></textarea>
                   </div>
   ...
   <div class="modal fade" id="ForSigningModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="ForSigningModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-m modal-dialog-centered rounded-4">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <div class="mb-2">
                       <textarea class="form-control rounded-4" id="forsigning_remarks" rows="2" oninput="adjustTextareaHeight(this)" placeholder="Remarks..."></textarea>
                   </div>
                   <div class="text-end">
   ...
   <div class="modal fade" id="ForReleasingModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="ForReleasingModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-m modal-dialog-centered rounded-4">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <div class="mb-2">
                       <textarea class="form-control rounded-4" id="forreleasing_remarks" rows="2" oninput="adjustTextareaHeight(this)" placeholder="Remarks..."></textarea>
                   </div>
                   <div class="text-end">
   ...
   <div class="modal fade" id="ReleasedModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="ReleasedModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-m modal-dialog-centered rounded-4">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <div class="mb-2">
                       <textarea class="form-control rounded-4" id="released_remarks" rows="2" oninput="adjustTextareaHeight(this)" placeholder="Remarks..."></textarea>
                   </div>
                   <div class="text-end">
   ...
   <div class="modal fade" id="OnHoldModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="OnHoldModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-m modal-dialog-centered rounded-4">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <div class="mb-2">
                       <textarea class="form-control rounded-4" id="onhold_remarks" rows="2" oninput="adjustTextareaHeight(this)" placeholder="Waiting for requester to submit necessary documents...."></textarea>
                   </div>
                   <div class="text-end">
   ...
   <div class="modal fade" id="DeniedModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="DeniedModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-m modal-dialog-centered rounded-4">
           <div class="modal-content rounded-4">
               ...
               <div class="modal-body">
                   <div class="mb-2">
                       <textarea class="form-control rounded-4" id="denied_remarks" rows="2" oninput="adjustTextareaHeight(this)" placeholder="(REQUIRED) Remarks..."></textarea>
                   </div>
                   <div class="text-end">
