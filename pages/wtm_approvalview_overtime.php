                        ...
                        <div class="p-3 rounded-3 border bg-light h-100">
                            ...
                            <select class="form-select rounded-4 mt-2" id="overtimetype_dropdown" name="overtimetype" disabled>
                                ...
                                <?php foreach ($ot_types as $ot) :
                                    $optionValue = $ot['ottype'] . ' - ' . $ot['description'];
                                ?>
            ...
            <?php if ($status === 'PENDING'): ?>
                <div class="d-flex justify-content-center gap-3 mb-2">
                    <div class="text-end mt-4">
                        <button type="button" id="approver_btn" class="btn btn-success px-4 rounded-4 mb-2" data-bs-toggle="modal" data-bs-target="#ApproveModal">Approve Application</button>
                        <button type="button" id="decline_btn" class="btn btn-danger px-4 rounded-4 mb-2" data-bs-toggle="modal" data-bs-target="#DeclineModal">Decline Application</button>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered rounded-4">
        <div class="modal-content rounded-4">
            ...
            <div class="modal-body" class="rounded-4 border-1 border-danger">
                ...
                <div id="approver-access" class="d-none mt-2">
                    <div class="col-md-12">
                        <div class="p-3 rounded-3 border bg-light h-100">

                            <div class="text-muted">
                                Excess: <span id="ot-excess-approval" class="fw-semibold mt-3" value="<?= $excess_hours ?>"><?= $excess_hours ?></span>
                            </div>

                            <div class="text-muted">
                                Filed Overtime: <span id="ot-file-approval" class="fw-semibold mt-3" value="<?= $excess_hours ?>"><?= $totalovertime ?></span>
                            </div>
                            <div class="text-muted">
                                Approved Overtime:
                                <input type="number"
                    ...
                    <div class="text-end mt-2">
                        <button type="button" id="approved_request" class="btn btn-success rounded-4">Approve application</button>
                        <button type="button" id="declined_request" class="btn btn-danger rounded-4">Decline application</button>
                    </div>
                </div>
...
<script src="../assets/js/wtm/wtm_overtime_approval.js"></script>
