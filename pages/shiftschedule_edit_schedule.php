...
while ($row = $res->fetch_assoc()) {
    ...
    $employeeShifts_description[$row['date']] = $row['sched_description'];
    ...
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
                ...
                <h5 class="mb-0 ms-3 text-muted text-center">Edit Shift Schedule</h5>
            </div>
