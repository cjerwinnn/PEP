...
<div class="container-fluid mb-2">
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            ...
            <!-- Request COE Button -->
            <button type="button" class="btn btn-primary rounded-4 mb-4" data-bs-toggle="modal" data-bs-target="#TaggingModal">
                Request COE
            </button>
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <div id="cePageInfoTop" class="small text-muted"></div>
            </div>
            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div id="ceTablePagination" class="small d-flex align-items-center gap-1">
                        ...
                        <span class="ms-3" id="cePageInfoBottom"></span>
                    </div>
                </div>
            </div>
        </div>
...
<!-- ========== Modal (Moved outside app-container) ========== -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 border rounded-4 h-100 shadow-sm">
                            <button type="button" class="btn btn-outline-secondary btn-lg w-100 rounded-pill"
                    ...
                    <div class="col-12">
                        <div class="p-3 border border-danger-subtle rounded-4 shadow-sm h-100">
                            <button type="button" class="btn btn-outline-danger btn-lg w-100 rounded-pill" data-bs-dismiss="modal">
                                Customized COE
                            </button>
                            <div class="small text-muted mt-2 text-center">
