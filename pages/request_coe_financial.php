...
<div class="container-fluid mb-2">
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            <h5 class="card-title mb-4 text-muted">COE Requisition Form for FINANCIAL</span></h5>
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <input type="text" class="form-control rounded-4 text-danger" id="req_coe_type" value="FINANCIAL" disabled>
                </div>
            </div>
