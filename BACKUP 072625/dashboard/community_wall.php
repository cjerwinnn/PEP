                           ...
                           <div class="card">
                               ...
                               <ul class="list-group list-group-flush">
                                   ...
                                   <li class="list-group-item d-flex justify-content-between align-items-start">
                                       <div>
                                           <p class="mb-1"><strong>Subject:</strong> <span> Process Time of Employee Documents Request</span></p>
                                           <p class="mb-1 text-muted"><small>Posted by: HR Department</small></p>
                                       </div>
                                       <a class="view-memo-btn ms-3" href="uploads/Memos/HR_MEMO_NO_222.pdf" target="_blank">View Memo (PDF)</a>
                                   </li>
                                   ...
                                   <li class="list-group-item d-flex justify-content-between align-items-start">
                                       ...
                                       <a class="view-memo-btn ms-3" href="uploads/Memos/memo-dresscode.pdf" target="_blank">View Memo (PDF)</a>
                                   </li>
                                   ...
                                   <li class="list-group-item d-flex justify-content-between align-items-start">
                                       ...
                                       <a class="view-memo-btn ms-3" href="uploads/Memos/memo-cleaning.pdf" target="_blank">View Memo (PDF)</a>
                                   </li>
