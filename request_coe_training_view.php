   <?php
    ...
    $checkListData = isset($_SESSION['checkListData']) ? $_SESSION['checkListData'] : [];
       ...
       <div class="card shadow rounded-4">
           <div class="card-body p-4">
               ...
               <div class="d-flex align-items-center my-4">
                   ...
                   <h5 class="mx-3 mb-0 text-muted small">Training/Educational Information</h5>
                   <hr class="flex-grow-1">
               </div>

               <div class="mb-2">
                   <label class="form-label small">Employee Title<span class="text-danger"> * </span><span class="text-muted fst-italic">(Encoded by HR)</span></label>
                   <input type="text" class="form-control rounded-4" id="emp_title" value="<?php echo htmlspecialchars($employee_title); ?>" disabled>
               </div>
               ...
               <div class="mb-4">
                   ...
                   <div id="compensation_details"
                       ...
                       data-original="<?= htmlspecialchars($purpose_details) ?>"
                       style="min-height: 80px; background-color: #e9ecef; opacity: 1;">
                       <?= $purpose_details ?>
                   </div>
               </div>
