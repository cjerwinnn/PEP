<div class="container-fluid mb-2">
    <div class="card shadow rounded-4" style="height: 90vh;">
        <div class="card-body p-4">
            <h5 class="text-muted">Request Forms</h5>

            <!-- ======================= Cards ================== -->
            <div class="cardBox position-relative">

                <!-- COE Button -->
                <button type="button" class="btn btn-outline-primary text-start p-4 rounded-4 shadow-sm d-flex justify-content-between align-items-center position-relative w-100 mb-3">
                    <!-- Notification Badge -->
