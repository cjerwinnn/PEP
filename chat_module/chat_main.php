    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary rounded-4" data-bs-dismiss="modal">No, Cancel</button>
                <button type="button" id="confirm-delete-btn" class="btn btn-danger rounded-4">Yes, Delete</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="chat-container">
        <div class="sidebar-panel" style="width: 25%; border-right: 1px solid #ccc; background: #f9f9f9; display: flex; flex-direction: column; height: 90vh;">
            ...
            <div id="group-tab" class="tab-content p-2">
                <button type="button" class="btn btn-primary btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#createGroupModal">
                    Create Group
                </button>
                <div id="group-list">
                </div>
